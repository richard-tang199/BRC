...
def PATE(y_true, y_score, e_buffer=100, d_buffer=100, pos_label=1, sample_weight=None, n_jobs=1, drop_intermediate=True, Big_Data=True, num_desired_thresholds=100, num_splits_MaxBuffer=1, include_zero=True, binary_scores=False):
    """
