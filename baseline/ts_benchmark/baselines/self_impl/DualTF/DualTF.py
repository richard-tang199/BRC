...
from baseline.ts_benchmark.baselines.self_impl.DualTF.model.FrequencyTransformer import (
    FrequencyTransformer,
)
from baseline.ts_benchmark.baselines.self_impl.DualTF.model.TimeTransformer import (
    AnomalyTransformer,
)
from baseline.ts_benchmark.baselines.self_impl.DualTF.utils.utils import (
...
if __name__ == "__main__":
    ...
    test_data = np.random.rand(1024, 1)
