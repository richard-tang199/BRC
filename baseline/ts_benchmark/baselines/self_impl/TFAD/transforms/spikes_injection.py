...
from baseline.ts_benchmark.baselines.self_impl.TFAD.transforms import TimeSeriesTransform
from baseline.ts_benchmark.baselines.self_impl.TFAD.transforms.base import get_magnitude
