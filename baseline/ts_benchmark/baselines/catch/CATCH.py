...
sys.path.append("baseline/ts_benchmark")
sys.path.append("baseline/ts_benchmark/baselines")
from catch.models.CATCH_model import (
    CATCHModel,
)
from baseline.ts_benchmark.baselines.utils import anomaly_detection_data_provider
from baseline.ts_benchmark.baselines.utils import train_val_split
...
if __name__ == "__main__":
    ...
    test_data = np.random.rand(10000, 1)
