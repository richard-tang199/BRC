...
#  python deep_baseline_compare.py --group $g --dataset_name TSB-AD-U --model_name cutaddpaste --plot False --device cuda:0 &
  python deep_baseline_compare.py --group $g --dataset_name TSB-AD-U --model_name couta --plot False --device cuda:0 &
  python deep_baseline_compare.py --group $g --dataset_name TSB-AD-U --model_name m2n2 --plot False --device cuda:0 &
