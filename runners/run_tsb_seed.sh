...
do
  for seed in $(seq 47 50)
  do
    python train_classify_mask.py --dataset_name TSB-AD-U  --group_name $g --model_name freq_tf_v2 --device "cuda:0" --plot False --num_epochs 300 --batch_size 128 --random_seed $seed
  done
done
