...
parser.add_argument("--group_name", type=str, default=[1, 2, 4, 5], help="group in the dataset")
...
if __name__ == '__main__':
    ...
    for dataset_idx, (train_data, train_window_length) in enumerate(zip(train_data_list, train_window_length_list)):
        ...
        for epoch in range(args.num_epochs):
            ...
            scheduler.step()
            print(f"dataset: {dataset_idx}, Epoch: {epoch}, Loss: {mean_loss}")
            if mean_loss < 0.03:
                break
    ...
    val_score_list = []
    test_score_list = []
    for anomaly_score, val_window_converter, test_window_converter in zip(anomaly_score_list, val_window_converter_list,
                                                                          test_window_converter_list):
    ...
    save_dir = f"incremental_results/{args.model_name}"
